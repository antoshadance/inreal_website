...
const jsContent = {
    ...
    article: `  <section>
                ...
                <ul>
                    ...
                    использованием современных технологий: <span class=${classes.emphasize}>React</span> и <span class=${classes.emphasize}>NodeJS</span></h2>
                    <h2>Виды веб-приложений:</h2>

                    <li class=${classes.bigLi}>${numberOneSvg} <span class=${classes.emphasize}>Single Page Application (SPA)</span>
                        <li class=${classes.liRighter}>
                    ...
                    <li class=${classes.bigLi}>${numberTwoSvg} <span class=${classes.emphasize}>Multi Page Application (SPA)</span>
                        <li class=${classes.liRighter}>
